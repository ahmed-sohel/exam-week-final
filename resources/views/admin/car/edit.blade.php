...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Edit Car</span>
    </h4>
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <form action="{{ url('admin/car', $car->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ $car->name }}" class="form-control"
                                id="defaultFormControlInput" placeholder="Car name"
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <input type="text" name="year" value="{{ $car->year }}" id="year"
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <input type="text" name="type" value="{{ $car->car_type }}" id="type"
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <input type="text" name="price" value="{{ $car->daily_rent_price }}" id="price"
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <select name="availability" id="availability" class="form-select">
                                <option value="1" @if ($car->availability == 1) selected @endif>Yes</option>
                                <option value="0" @if ($car->availability == 0) selected @endif>No</option>
                            </select>
                        </div>
                    </div>
                    <div class="card-body">
